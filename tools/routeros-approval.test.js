...
const model = { fingerprint: 'actual', routeros: { major: 7 }, source: { name: 'fixture' }, resources: [], diagnostics: [] };
...
assert.strictEqual(attached.approval.artifact.approval.change_set_fingerprint, withSnapshot.fingerprint);
assert.notStrictEqual(attached.fingerprint, withSnapshot.fingerprint);
