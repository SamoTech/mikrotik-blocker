...
const snapshot = createSnapshot({ fingerprint: 'actual-test', routeros: { version: '7.21.4', major: 7 }, resources: [], diagnostics: [] }, {
...
const ready = createDeploymentPlan(approved, { routeros_version: '7.21.4', routeros_major: 7 });
...
const blocked = createDeploymentPlan(base, { routeros_version: '7.21.4', routeros_major: 7 });
